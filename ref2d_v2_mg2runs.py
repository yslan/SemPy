...
results['mg2Ihs']  = np.empty((0,5)) # N, niter, err, t_solve, t_elapsed
results['mg2Ihb']  = np.empty((0,5)) # N, niter, err, t_solve, t_elapsed
results['mg2Ims']  = np.empty((0,5)) # N, niter, err, t_solve, t_elapsed
results['mg2Imb']  = np.empty((0,5)) # N, niter, err, t_solve, t_elapsed
results['mg2Bhs']  = np.empty((0,5)) # N, niter, err, t_solve, t_elapsed
results['mg2Bhb']  = np.empty((0,5)) # N, niter, err, t_solve, t_elapsed
results['mg2Bms']  = np.empty((0,5)) # N, niter, err, t_solve, t_elapsed
results['mg2Bmb']  = np.empty((0,5)) # N, niter, err, t_solve, t_elapsed
...
#       print('mg',N,err,tol)
    ...
    tag = 'mg2Ihs'
    U, niter, err, t_solve, t_elapsed = solve_twolevels(Ax_2d,relax,relaxSetup
...
def plot_aux(data,idx,cc,stry,ifsave,strf):
    ...
    pfun(data['mg2Ihs'][:,0],data['mg2Ihs'][:,idx],":o", color=cc[4], label="mg2Ihs (2lv "+str_lg+")") 
    pfun(data['mg2Ihb'][:,0],data['mg2Ihb'][:,idx],":^", color=cc[5], label="mg2Ihb (2lv "+str_lg+")")
    pfun(data['mg2Ims'][:,0],data['mg2Ims'][:,idx],"-o", color=cc[6], label="mg2Ims (2lv "+str_lg+")")
    pfun(data['mg2Imb'][:,0],data['mg2Imb'][:,idx],"-^", color=cc[7], label="mg2Imb (2lv "+str_lg+")")
    pfun(data['mg2Bhs'][:,0],data['mg2Bhs'][:,idx],":o", color=cc[8], label="mg2Bhs (2lv "+str_lg+")")
    pfun(data['mg2Bhb'][:,0],data['mg2Bhb'][:,idx],":^", color=cc[9], label="mg2Bhb (2lv "+str_lg+")")
    pfun(data['mg2Bms'][:,0],data['mg2Bms'][:,idx],"-o", color=cc[10],label="mg2Bms (2lv "+str_lg+")")
    pfun(data['mg2Bmb'][:,0],data['mg2Bmb'][:,idx],"-^", color=cc[11],label="mg2Bmb (2lv "+str_lg+")")
